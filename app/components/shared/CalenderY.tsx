...
interface CalenderYProps {
  user: User | null,
  day?: Day; // Making day optional
}

const CalenderY/* : React.FC<CalenderYProps> */ = (/* { user, day } */) => {
 /*  React.useEffect(() => {
    if (user) {
      console.log(user)
    }
  ...
  useEffect(() => {
    const fetchShifts = async () => {
      try {
        ...
        if (user && user.id) {
          const userShifts = await haalGeplaatsteShifts(user.id);
