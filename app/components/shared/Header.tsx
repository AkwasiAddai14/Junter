        ...
        <div className="mx-auto max-w-7xl">
            <nav className="flex-grow items-align place-items-center justify-evenly lg:justify-start" aria-label="Global"> <a href="/" className="-m-1.5 p-1.5">
                ...
                <Image
                  ...
                  src={require('/Users/georgeaddai/Desktop/thejunter/thejunter/app/assets/images/178884748_padded_logo.png')}
                  width={72}
                  height={56}
                  />
              </a>
            ...
            <div className="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
              <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                ...
                <div className="mt-10 flex items-center gap-x-6">
                  ...
                  <a href="#Branches" className="text-sm font-semibold leading-6 text-gray-900">
