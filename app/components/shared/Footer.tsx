...
const navigation = {
  ...
  Junter: [
    ...
    { name: 'Werken bij', href: '../junter' },
    { name: 'Partners', href: '../junter' },
  ],
  legal: [
    { name: 'Contact', href: '../contact' },
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold leading-6 text-gray-900">Junter</h3>
                <ul role="list" className="mt-6 space-y-4">
          ...
          <div className="mt-10 xl:mt-0">
            <h3 className="text-sm font-semibold leading-6 text-gray-900">Aboneer op onze nieuwsbrief</h3>
            ...
            <form onSubmit={handleSubmit} className="mt-6 sm:flex sm:max-w-md">
              ...
              <div className="mt-4 rounded-md sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                <button
                  type="submit"
                  className="flex w-full items-center justify-center rounded-md bg-sky-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Abonneren
                </button>
              </div>
