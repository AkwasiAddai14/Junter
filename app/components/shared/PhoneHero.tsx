      ...
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            <h1 className="text-4xl font-medium tracking-tight text-gray-900"> Control
            ...
            <p className="mt-6 text-lg text-gray-600">
              Mis geen enkele kans, 
              houd al je projecten en communicatie op één plek en ontvang je betalingen sneller dan ooit. 
              Download nu en begin vandaag nog!
            </p>
