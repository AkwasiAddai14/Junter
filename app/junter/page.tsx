          ...
          <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
              <h1 className="max-w-2xl text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl lg:col-span-2 xl:col-auto">
                ...
                We zijn een gepassioneerde groep mensen. 
  
              </h1>
              <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                <p className="text-lg leading-8 text-gray-600">
                Onze diversiteit en gedeelde visie drijven ons om innovatieve oplossingen te creëren die de manier waarop bedrijven en klanten met elkaar omgaan, transformeren.
                </p>
              </div>
              <img
          ...
          <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
              <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Onze mensen</h2>
                <p className="mt-6 text-xl leading-8 text-gray-600">
                Onze mensen zijn ons grootste kapitaal. Ze brengen expertise, passie en toewijding in alles wat ze doen.
                </p>
                <p className="mt-6 text-base leading-7 text-gray-600">
                We zijn trots op onze diverse en getalenteerde teams die samenwerken om geweldige resultaten te bereiken. 
                Samen bouwen we aan een toekomst waarin innovatie en samenwerking centraal staan.
                </p>
              </div>
 ...
 */}
      ...
      <nav className="-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12" aria-label="Footer">
        ...
        &copy; 2024 Junter. Alle rechten voorbehouden.
        </p>
      </footer>
    </div>
  )
