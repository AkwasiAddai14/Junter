  ...
  const bigfeatures = [
    {
      name: 'Kosten',
      description:
        'Door te kiezen voor ons platform, profiteer je van een transparant en eenvoudig kostenmodel, waarbij je alleen betaalt voor de daadwerkelijk gewerkte uren van de freelancers die je uitnodigt. Nodig onbeperkt freelancers uit voor een vast tarief van €17,50 per gewerkt uur per freelancer.',
